...
def create_app():
    ...
    # Register blueprints
    from .routes import main_blueprint, admin_blueprint, categories_blueprint, labor_blueprint, packaging_blueprint, production_blueprint, weekly_costs_blueprint, reports_blueprint
